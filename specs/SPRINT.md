...
- **W6.1.1** — cross-compile the `mvm-guest-agent` Rust binary for target Linux and bake it into the rootfs. Needs a Linux builder; deferred from W6.1 because the cross-compile dep is non-trivial.
