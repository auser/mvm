...
- [x] CI follow-up (2026-05-27): Plan 104 W1b.2b.2 now shares the broker subprocess substrate allowlist, tolerates EOF-or-reset on the oversized-frame rejection test, removes the stale `CommandExt` import in supervisor spawn, and documents the `SecretsProxy` debug carveout for the secret-type lint.
