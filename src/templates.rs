...
use crate::vm::tenant::config::TenantQuota;
use crate::vm::tenant::lifecycle::{tenant_list, tenant_load};
...
mod tests {
    ...
    fn test_allocate_net_id_with_existing() {
        ...
        crate::vm::tenant::lifecycle::tenant_create(
            "alpha",
            crate::vm::tenant::config::TenantNet::new(3, "10.240.3.0/24", "10.240.3.1"),
            TenantQuota::default(),
        )
        .unwrap();
        crate::vm::tenant::lifecycle::tenant_create(
            "beta",
            crate::vm::tenant::config::TenantNet::new(7, "10.240.7.0/24", "10.240.7.1"),
            TenantQuota::default(),
        )
        .unwrap();
...
"#;
    ...
    fn test_new_deployment_end_to_end() {
        ...
        let net = crate::vm::tenant::config::TenantNet::new(net_id, &subnet, &gateway);
        let config =
            crate::vm::tenant::lifecycle::tenant_create("myapp", net, template.quotas.clone())
                .unwrap();
        ...
        for pool_tmpl in &template.pools {
            ...
            let spec = crate::vm::pool::lifecycle::pool_create(
                "myapp",
                pool_tmpl.pool_id,
        ...
        let mut pools = crate::vm::pool::lifecycle::pool_list("myapp").unwrap();
        pools.sort();
